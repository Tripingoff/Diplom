...
namespace ИС_ККТД.Models
{
    ...
    public partial class IS_KKTDEntities : DbContext
    {
        public static IS_KKTDEntities _context;
        public static IS_KKTDEntities GetContext()
        {
            if (_context == null)
                _context = new IS_KKTDEntities();
            return _context;
        }
        public IS_KKTDEntities()
            : base("name=IS_KKTDEntities")
        {
        }
        ...
        public virtual DbSet<Ведомости> Ведомости { get; set; }
        public virtual DbSet<Вид_зачета> Вид_зачета { get; set; }
